...
c = []
while True:
    print('Being processed picture %s' % index_frame)
    ...
    if (index_frame % 8 == 0):
        ...
        for i, d in enumerate(dets):
            ...
            path_init = output_dir + '/' + mac_addr + cur_time+str(index_frame) + str(i) + '.jpg'
            path_aligned = output_dir + '/' + mac_addr + cur_time + str(index_frame) + str(i) + '_init.jpg'
            ...
            if detector_scores[i] > 0.8 and -20<socore_result[0]<20 and -20<socore_result[1]<20 and -20<socore_result[2]<20:
            ...
            #sftp_upload(host, port, username, password, local, remote)#上传所有图片？
                ...
                cv2.putText(img, text, (x1*scale, y1*scale), font, 1, (255, 0, 0), 2)
        ...
        for i, text in enumerate(text_list):
            cv2.putText(img, text, (coord_list[i][0], coord_list[i][1]), font, 1, (255, 0, 0), 2)
            # cv2.putText(img, 'x:' + str(socore_result[0])[1:6], (50, 50), font, 2, (0, 255, 255), 2)
            # cv2.putText(img, 'y:' + str(socore_result[1])[1:6], (50, 100), font, 2, (0, 255, 255), 2)
            # cv2.putText(img, 'z:' + str(socore_result[2])[1:6], (50, 150), font, 2, (0, 255, 255), 2)
